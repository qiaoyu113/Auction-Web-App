<template>
    ...
    <div class="" id="" v-set-title="title">
        ...
        <div class="container">
            <div class="nav">
                <span class="">正在进行</span><span class="check">即将开始</span><span>历史记录</span>
            </div>
            <div class="sell">
                <div class="sell-content">
                    <div class="sell-time">00:00:00:00</div>
                    <div class="sell-title">器物拍卖专场</div>
                    <div class="sell-information">
                        <a href="#">拍卖已开始，快去捡漏吧</a>
                        <span class="iconfont icon-shangcheng pos1"> 50</span>
                        <span class="iconfont icon-qunzu pos2"> 20000</span>
                        
                    </div>
                </div>
                <div class="sell-picture">
                    <div class="sell-bpic">
                        <i><a href="www.baidu.com">ING</a></i>
                        <i class="iconfont icon-xing pos"><a href="#"></a></i>
            ...
            <div class="sell">
                <div class="sell-content">
                    <div class="sell-time">150,000CNY</div>
                    <div class="sell-title">器物拍卖专场</div>
                    <div class="sell-warn">2017.09.01 9:00开始
                        <span class="iconfont icon-shangcheng pos1"> 50</span>
                        <span class="iconfont icon-qunzu pos2"> 20000</span>
                    </div>
                </div>
