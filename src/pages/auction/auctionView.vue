    ...
    <div id="auction" v-set-title="title">
        ...
        <div class="dis">
            ...
            <div :class="dis ? 'record recordShow' : 'record'"  v-if="dis">
                <div class="down" ><i class="iconfont icon-xialajiantou" style="color:#A9AEB6;font-size:32px;"></i></div>
                <div class="disShow">
        ...
        4拍品被流拍
        5拍品被自己拍中-->
        <div class="infomation bground1 clearfix" v-if="details.auctionStatus === null">
            <div class="time1 fr">
        ...
        <!--底部-->
        <!--起拍价格-->
        <div class="footer" v-if="details.auctionStatus === null">
            <div class="value">
        ...
        <div class="dis2" v-if="dis2Show">
            ...
            <div class="popWin" >
                <div class="close" ><i class="iconfont icon-closeicon"></i></div>
...
//                let socket = new SockJS('http://shik.s1.natapp.cc/auction');
            ...
            getListData:function(pageNum,pageSize,successCallback,errorCallback) {
                //延时一秒,模拟联网
                const that = this;
                commonService.getAuction({id:that.id,view:true},that.id).then(function(res){
                    if(res.data.code === 200){
                        ...
                        successCallback&&successCallback(that.details);//成功回调
