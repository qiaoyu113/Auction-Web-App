                            ...
                            <div class="ros clearfix" v-for="(list,index) in myList"  @click="Router(list.auction._id)">
                                ...
                                <div class="ros_l">
                                    ...
                                    <div class="ros_l_top clearfix" v-if="list.auction.marketStatus == 0">
                                        <div class="ros_prompt">拍品已下架</div>
                                        <div class="ros_label" v-if="list.auctionCollect.show">NEW</div>
                                    </div>
                                ...
                                <div class="ros_r">
                                    ...
                                    <div class="date">
                                        ...
                                        <!--预展中-->
                                        <div class="collect3"  v-if="list.auction.auctionStatus == 1">
                                            <div class="icon"></div>
                                        </div>
                                        <!--已结束-->
                                        <div class="collect4"  v-if="list.auction.auctionStatus == 3 || list.auction.auctionStatus == 5">
                                            <div class="icon"></div>
                                            <div class="icon2"></div>
                                        </div>
                                        <!--流拍-->
                                        <div class="collect5"  v-if="list.auction.auctionStatus == 4">
                                            <div class="icon"></div>
                                            <div class="icon2"></div>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            getListData:function(pageNum,pageSize,successCallback,errorCallback) {
                //延时一秒,模拟联网
                const that = this;
                commonService.getCollect({pageNo:pageNum,pageSize:pageSize,status:3}).then(function(res){
